...
This portfolio represents my growth throughout the Computer Science program at Southern New Hampshire University. It demonstrates my experience in software engineering, algorithms and data structures, database development, security, testing, debugging, and professional communication.

My primary artifact is the **Animal Shelter Dashboard**, originally developed in CS 340: Client/Server Development. Throughout CS 499, I enhanced this application in three major areas:
...
- Refactored the CRUD module into a cleaner object-oriented design.
- Added stronger input validation for database operations.
...
The second enhancement focused on **algorithms and data structures**.
...
- Reorganized filtering logic into reusable configuration-based structures.
- Reduced duplicated filtering operations.
...
The third enhancement focused on the **database layer** of the Animal Shelter Dashboard.
...
Completing this capstone has shown me how much my approach to software development has changed throughout the Computer Science program.

I now look beyond whether an application simply works. I also consider whether the software is maintainable, efficient, secure, understandable to other developers, and capable of adapting as requirements change.
